...
class wcff_ajax {
	...
	function handleRequest() {
		...
		if( wcff()->request["context"] == "wcff_cart_field_render" )	{			
			$data = apply_filters( 'wcff/update/item/cart', wcff()->request["payload"] );
		} else if( wcff()->request["context"] == "update_cart_item_from_session" ){
			$data = apply_filters( 'wcff/update/item/cart/session_item', wcff()->request["payload"] );
		}else if( wcff()->request["context"] == "product" ) {		
