...
class wcff_field_file extends wcff_field {
	...
	function __construct() {
		...
		remove_action( 'woocommerce_after_shop_loop_item', false, 10);
	...
	function render_wcff_setup_fields( $type = "wccpf" ) { ob_start(); ?>
		...
		<tr>
			<td class="summary">
				<label for="post_type"><?php _e( 'Preview Option', 'wc-fields-factory' ); ?></label>
				<p class="description"><?php _e( 'If image File preview image or file name', 'wc-fields-factory' ); ?></p>
			</td>
			<td>
				<div class="wcff-field-types-meta" data-type="radio" data-param="img_is_prev">
					<ul class="wcff-field-layout-horizontal">
						<li><label><input type="radio" name="wcff-field-type-meta-img_is_prev" value="yes" /> <?php _e( 'Yes', 'wc-fields-factory' ); ?></label></li>
						<li><label><input type="radio" name="wcff-field-type-meta-img_is_prev" value="no" checked/> <?php _e( 'No', 'wc-fields-factory' ); ?></label></li>
					</ul>				
				</div>
				<div class="wcff-field-types-meta" data-type="text" data-param="img_is_prev_width">
					<input type="text" id="wcff-field-type-meta-img_is_prev_width" value="" placeholder="<?php _e( 'Image width px', 'wc-fields-factory' ); ?>" />	
				</div>
			</td>
		</tr>
		<tr>
			<td class="summary">
				<label for="post_type"><?php _e( 'Upload Path', 'wc-fields-factory' ); ?></label>
				<p class="description"><?php _e( 'Separate upload path', 'wc-fields-factory' ); ?></p>
			</td>
			<td>
				<div class="wcff-field-types-meta" data-type="text" data-param="upload_url">
					<input type="text" id="wcff-field-type-meta-upload_url" value="" placeholder="<?php _e( 'Enter separate path if leave it blank upload default path.', 'wc-fields-factory' ); ?>" />						
				</div>
			</td>
		</tr>			
		<tr>
	...
	function render_product_field( $field ) {
		...
		<?php if( has_action('wccpf/before/field/rendering' ) && has_action('wccpf/after/field/rendering' ) ) : ?>
			...
			<input type="file" <?php echo isset( $field['max_file_size'] ) ? 'max-size="'. $field["max_file_size"].'"' : ''; ?> class="wccpf-field<?php echo $field_class; ?>" name="<?php echo esc_attr( $field["name"] . $name_index . $multifile_support ); ?>" accept="<?php echo $field["filetypes"]; ?>" <?php echo ( isset( $field["multi_file"] ) && $field["multi_file"] == "yes" ) ? 'multiple="multiple"' : ''; ?> wccpf-type="file" wccpf-pattern="mandatory" wccpf-mandatory="<?php echo $field["required"]; ?>" />
