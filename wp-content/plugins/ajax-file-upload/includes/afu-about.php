...
<div class="wrap about-wrap">
	...
	<div style="display: inline-block; max-width: 30%; vertical-align: top;">
		...
		<ol>
			<?php foreach ( $atts as $attribute => $val ) : ?>
				<li><a href=#<?php echo $attribute; ?>><code><?php echo $attribute; ?></code></a></li>
			<?php endforeach; ?>
		</ol>
	...
	<div style="display: inline-block; max-width: 65%; vertical-align: top; margin-left: 7px;">
		...
		<h3 id="unique_identifier">1. unique_identifier <span style="font-size:80%;font-weight:normal;">&mdash; required</span></h3>
		...
		<h3 id="max_size">2. max_size <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="allowed_extensions">3. allowed_extensions <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="permissions">4. permissions <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="on_success_alert">5. on_success_alert <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="on_fail_alert">6. on_fail_alert <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="on_fail_alert_error_message">7. on_fail_alert_error_message <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="on_success_set_input_value">8. on_success_set_input_value <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="set_background_image">9. set_background_image <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="set_image_source">10. set_image_source <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="disallow_remove_button">11. disallow_remove_button <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="disallow_reupload">12. disallow_reupload <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="upload_button_value">13 upload_button_value <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="select_file_button_value">14. select_file_button_value <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="remove_file_button_value">15. remove_file_button_value <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="show_preloader">16. show_preloader <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="default_loading_text">17. default_loading_text <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="on_success_dialog_prompt_value">18. on_success_dialog_prompt_value <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		...
		<h3 id="hide_if_no_permissions">19. hide_if_no_permissions <span style="font-size:80%;font-weight:normal;">&mdash; optional</span></h3>
		<p>If a user does not have permissions to upload (as per what you input in <a href=#permissions><code>permissions</code></a> attribute or its default), then this user will no longer be able to use the upload buttons if you set this attribute.<br/>Example use: <code>hide_if_no_permissions="true"</code></p>
...
window.addEventListener( "afu_file_removed", function(e){
	...
	<h3>afu_upload_loading</h3>

	<p>Runs right before an upload in being initiated. It can be used to do stuff while a user is waiting in the front-end for a file to process. Use other events to stop this when needed.</p>
...
window.addEventListener( "afu_upload_loading", function(e){
	...
	<p>If you like it by far, please take some time to leave us a &star;&star;&star;&star;&star; rating on WordPress, a star &star; on the Github repository, and thank you for your time!</p>
...
<script>
	window.onload = function() {
		document.title = "Welcome to AJAX File Upload " + document.title;
	}
</script>