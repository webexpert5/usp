...
<div class="bootstrap-iso">
    <div class="popover-markup<?php echo $product_id . $variation_id ?>">
        <button type="button" class="trigger btn btn-default"><?php echo $uploadButtonTitle ?></button>
        <?php
...
<script>
    ...
    jQuery(document).ready(function ($) {
        ...
        $(".popover-markup<?php echo $product_id . $variation_id ?> >.trigger").popover(
            {
                html: true,
                title: function () {
                    ...
                    init: function () {
                        ...
                        this.on('removedfile', function (file) {
                            ...
                            if ($('#woo_file_dropzone_file_sent<?php echo $product_id . $variation_id ?>').length) {
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        'woo_file_dropzone_upload_nonce': $('input[name="woo_file_dropzone_upload_nonce"]').val(),
                            ...
                            if (!this.files.length) {
                                $('#woo_file_dropzone_file_sent<?php echo $product_id . $variation_id ?>').remove();
                                $('#wooFileDropzoneForm<?php echo $product_id . $variation_id ?> .dz-message').text(messageAllowedNumberOfFiles).show();
                            }
                        ...
                        if ($('#woo_file_dropzone_file_sent<?php echo $product_id . $variation_id ?>').length) {
                            $('#wooFileDropzoneForm<?php echo $product_id . $variation_id ?> .dz-message').text('Loading...');
                            $.ajax({
                                url: wooDropFilesAjaxUrl,
                                type: 'POST',
                                dataType: 'JSON',
                        ...
                        if ($('#woo_file_dropzone_file_sent<?php echo $product_id . $variation_id ?>').length) {
                            variation_id = $('#woo_file_dropzone_file_sent<?php echo $product_id . $variation_id ?>').val();
                        }
                        ...
                        $(document).on('click', "#trigger<?php echo $product_id . $variation_id; ?>", function () {
                            ...
                            if ($('#wooFileDropzoneForm<?php echo $product_id . $variation_id ?>'
                                    + ' input[id^="woo_file_dropzone_field_"]:visible').length) {
                                $('#wooFileDropzoneForm<?php echo $product_id . $variation_id ?>'
                            ...
                            if ($('#wooFileDropzoneForm<?php echo $product_id . $variation_id ?>' +
                                    ' textarea[id^="woo_file_dropzone_field_"]:visible').length) {
                                $('#wooFileDropzoneForm<?php echo $product_id . $variation_id ?>'
                            ...
                            self.on("completemultiple", function () {
                                ...
                                $("<input type='hidden' id='woo_file_dropzone_file_sent<?php echo $product_id ?>" + variation_id + "' value='" + variation_id + "'/>")
